...
| schemas.py | API schema layer | Defines request/response validation models, including semester Reading Week fields, plugin shared settings payloads, strict widget `layout_config` shape/range validation, and fact-oriented gradebook contracts built around percentage scores. |
