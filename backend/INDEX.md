...
The backend now exposes generic LMS course import, Course link/relink/unlink, and read-only Assignment plus Calendar APIs without leaking secrets, with Canvas implemented through a REST adapter that normalizes provider-specific due-date recognition before data reaches shared LMS consumers.
