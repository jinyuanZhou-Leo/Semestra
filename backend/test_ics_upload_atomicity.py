...
# output: [backend regression tests ensuring course ICS uploads remain atomic when schedule import fails]
# pos:    [backend API regression tests covering transactional guarantees for ICS-based course creation routes without an HTTP client dependency]
#
