...
Runtime code no longer owns ad-hoc schema rewrite steps; structural changes such as course resources, multi-integration LMS storage, Program LMS selection, and Course LMS link tables should land here first.
...
| versions/ | Revision history | Versioned migration scripts for backend schema changes, including LMS integration and Course link expansions. |
