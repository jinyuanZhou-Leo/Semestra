...
Plugin implementations live under `plugins/`, including recent UX hardening for course-list feedback, a FullCalendar-backed calendar surface with overflow-to-week access, scroll-first small-screen behavior, tokenized conflict styling, lighter unwrapped today emphasis, draft-friendly calendar time inputs, timezone-safe semester date parsing, semester Reading Week-aware event suppression and week numbering, occurrence-scoped conflict details without top summary badges, semester/course todo + all-day calendar overlays with live refresh, todo destructive confirmations, widget validation/localization behavior, and scoped event-core schedule refresh + bounded semester todo loading.
