...
| ProgramDashboard.tsx | Route page | Program workspace route with compact one-row mobile overview metrics to keep the semester list visible earlier while preserving desktop layout behavior. |
