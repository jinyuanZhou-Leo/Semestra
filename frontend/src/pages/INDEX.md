...
| ProgramDashboard.tsx | Route page | Program workspace route with compact mobile overview stat strip, responsive create-semester surface, modal-based program settings that auto-save without an explicit save button, and shared course-category badge colors reused by Todo. |
