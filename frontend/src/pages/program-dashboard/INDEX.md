...
| CreateSemesterWizardButton.tsx | Wizard trigger | Routes into the standalone Create Semester page and handles resume/discard decisions when a draft already exists, backed by the app-side Program draft/detail resource layer. |
