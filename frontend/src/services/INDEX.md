...
| queryKeys.ts | Service module | Canonical query-key factory used by contexts, hooks, and plugin surfaces to share cached gradebook, LMS integration/link, LMS calendar/assignment, resource, and settings data consistently. |
