...
|------|------|-------------|
| api.ts | Service module | REST gateway for program/semester/course CRUD, including semester Reading Week payload fields plus plugin shared settings list/upsert endpoints alongside widget/tab contracts. |
