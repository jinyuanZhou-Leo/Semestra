...
Central place for retry policy, cookie-auth HTTP defaults, schedule API calls, plugin shared settings persistence, and plugin registration rules.

| File | Role | Description |
|------|------|-------------|
| api.ts | Service module | REST gateway for program/semester/course CRUD, plugin shared settings, note-free fact-oriented course gradebook endpoints, and widget/tab contracts including force-aware widget deletion. |
