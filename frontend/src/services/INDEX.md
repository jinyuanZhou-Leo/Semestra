...
|------|------|-------------|
| api.ts | Service module | REST gateway for program/semester/course CRUD including semester todo endpoints without backend-side todo reordering, persisted course colors, plugin shared settings, score-based course gradebook endpoints, and widget/tab contracts including force-aware widget deletion. |
