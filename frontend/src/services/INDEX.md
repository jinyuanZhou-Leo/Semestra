...
| queryKeys.ts | Service module | Canonical query-key factory used by contexts, hooks, and plugin surfaces to share cached gradebook, LMS integration/link, Canvas navigation/page/quiz/syllabus browser, range-scoped LMS calendar data, semester calendar schedule windows, resource, and settings data consistently. |
