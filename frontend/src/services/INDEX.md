...
|------|------|-------------|
| api.ts | Service module | REST gateway for program/semester/course CRUD, plugin shared settings, dedicated course gradebook endpoints, and widget/tab contracts including force-aware widget deletion. |
