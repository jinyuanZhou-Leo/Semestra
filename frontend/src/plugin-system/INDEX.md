...
`contracts.ts` defines the plugin authoring helpers and `PluginLoadSkeleton.tsx` provides loading skeletons plus widget-ring-matched loading helpers.
...
| PluginLoadSkeleton.tsx | Plugin runtime module | Simple tab loading skeletons, widget-card-aligned loading shells, and shared fade-in wrapper for lazy tab/widget plugin content. |
