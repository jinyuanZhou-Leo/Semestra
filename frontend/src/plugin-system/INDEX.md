...
| setupRegistry.ts | Setup registry | Eagerly scans `plugins/*/plugin.ts`, validates each setup declaration against its plugin definition, and keeps custom UI/validation hooks available to the frontend wizard. |
