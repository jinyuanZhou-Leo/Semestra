...
| settings.tsx | Settings entry | Owns the Calendar, Course Schedule, and Todo tab settings components without changing how the runtime definitions consume them. |
