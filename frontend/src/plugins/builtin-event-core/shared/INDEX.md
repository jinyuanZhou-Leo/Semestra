...
| types.ts | Shared types | Schedule/event payload types shared across tabs, widget, settings surfaces, and external Calendar-source refresh wiring, including `calendar-core` event re-exports and week-view screen-width calendar settings state. |
