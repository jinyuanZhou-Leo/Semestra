...
| types.ts | Contract types | Defines Calendar events, source definitions, refresh signals including gradebook assessment updates, optional event subtitles, optional todo completion metadata, and semester-range plus query-range context shared across Calendar consumers. |
