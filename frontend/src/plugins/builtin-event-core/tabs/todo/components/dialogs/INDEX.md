...
| TodoTaskDialog.tsx | Full-detail task dialog | Secondary editor for task note, section assignment, and structured task fields when inline editing is not enough, now using a scroll-safe long-form dialog body with fixed footer actions. |
