...
| lmsSource.ts | LMS source | Reuses semester LMS Calendar queries, serves read-only LMS semester events, and maps them into calendar-core event data with local course-code titles plus LMS event-name subtitles and no edit support. |
