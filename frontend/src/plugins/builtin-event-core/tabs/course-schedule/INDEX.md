...
| CourseScheduleSettings.tsx | Settings panel | Manages course event types for the course-schedule tab settings surface with a tighter mobile data table, a shadcn-style row-actions dropdown for edit/delete actions, and semester-scoped refresh events. |
