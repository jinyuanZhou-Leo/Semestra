...
The tab now exposes explicit keyboard-accessible expand controls plus atomic batch toggles for section details.

| File | Role | Description |
|------|------|-------------|
| INDEX.md | Architecture index | Local map for the course-schedule tab files and responsibilities. |
| CourseScheduleTab.tsx | Main runtime | Renders the section table, accessible expand controls, atomic section toggles, and section deletion flows. |
