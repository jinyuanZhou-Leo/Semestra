...
import { EmptyTableRow, PanelHeader, TableShell } from '@/components/DataTable';
                        ...
                        <div className="flex justify-end gap-1" onClick={(event) => event.stopPropagation()}>
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent size="sm">
                              <AlertDialogHeader>
                                <AlertDialogTitle>Delete section {section.sectionId}?</AlertDialogTitle>
                                <AlertDialogDescription>
                                  This action cannot be undone. All events under this section will be deleted.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                ...
                                <AlertDialogAction
                                  variant="destructive"
                                  onClick={() => void handleDeleteSection(section.sectionId)}
                                >
                                  Delete
                                </AlertDialogAction>
                              </AlertDialogFooter>
