...
| habit-streak/INDEX.md | Plugin architecture index | File map for habit-streak per-instance state helpers, split widget files, delete cleanup behavior, mode-specific settings, and burst animation behavior. |
