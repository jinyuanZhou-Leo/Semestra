...
| builtin-canvas-integration/ | Built-in tab plugin | Canvas-only course navigation tab with a compact left-side rail, Home/Announcements/Modules/Pages sections, and in-app same-course page links. |
