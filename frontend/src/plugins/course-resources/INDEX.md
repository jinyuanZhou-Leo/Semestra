...
Its add-resource dialog now stores the active sub-tab plus saved-link form fields in plugin UI storage so link drafts survive tab remounts, while uploaded files stay as in-memory session state.
