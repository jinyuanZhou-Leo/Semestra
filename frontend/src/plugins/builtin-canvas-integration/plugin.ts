// input:  [canvas integration descriptor, frontend plugin SDK, and lazy runtime loader]
// output: [default-exported descriptor-backed canvas integration plugin definition]
// pos:    [builtin plugin entry that reads static JSON metadata while deferring runtime loading]
//
