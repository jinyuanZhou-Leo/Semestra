...
Currently this folder owns the LMS integration manager used by the global settings workspace and the provider definition helpers that keep Canvas-specific payload wiring out of the manager component.
