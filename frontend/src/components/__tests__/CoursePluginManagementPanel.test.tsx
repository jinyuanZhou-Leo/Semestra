// input:  [`CoursePluginManagementPanel`, mocked course-governance APIs, QueryClient wrapper, and testing-library interactions]
...
import { CoursePluginManagementPanel } from "../CoursePluginManagementPanel";
...
describe("CoursePluginManagementPanel", () => {
  beforeEach(() => {
        ...
        pluginActivations={[
          {
            ...
            version: "workspace",
            is_enabled: false,
            capabilities: { contexts: ["course"], available_tab_types: ["course-resources-tab"] },
            available: false,
