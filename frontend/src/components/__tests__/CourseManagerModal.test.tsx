...
// output: [regression tests covering close-after-create behavior when post-create refresh fails]
// pos:    [Component regression suite that ensures successful course creation closes the modal even if parent refresh work rejects afterward]
//
