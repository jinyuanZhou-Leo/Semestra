// input:  [plugin tab catalog, current dashboard tab instances, tab add callback, search state, responsive overlay wrapper]
// output: [`AddTabModal` component]
// pos:    [Responsive add-tab selector surface for course/semester pages (desktop dialog + mobile drawer)]
//
...
export const AddTabModal: React.FC<AddTabModalProps> = ({ isOpen, onClose, onAdd, context, tabs }) => {
    ...
    return (
        <ResponsiveDialogDrawer
            ...
            title="Add Tab"
            description="Search and select a tab to add to your dashboard."
