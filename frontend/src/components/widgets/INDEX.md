...
| DashboardGrid.tsx | UI component | Uses RGL v2 `useContainerWidth` (`1w = 1h`) with lower-frequency stabilized width commits, zero-width render guards on tab remount, interaction-scoped local layout sync, drag/resize commit persistence callbacks, and unavailable-widget delete overrides. |
