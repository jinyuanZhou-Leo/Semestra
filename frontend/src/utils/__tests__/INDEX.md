...
Current suite validates auth redirect restoration, GPA mapping, Program Home Focus Board config behavior, and edge-case parsing behavior.
...
| programHome.test.ts | Test file | Unit tests for Program Home Focus Board config parsing, pin deduplication, and pin removal helpers. |
