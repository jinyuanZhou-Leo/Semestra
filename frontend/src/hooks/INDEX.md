...
Includes stale-request-safe fetch primitives, shared gradebook/todo query hooks, backend-backed runtime tab order/settings sync, host-reserved homepage shell-tab orchestration, and force-aware cleanup for unavailable widgets.
