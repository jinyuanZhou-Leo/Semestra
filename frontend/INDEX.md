...
| package.json | Package manifest | Frontend scripts, dependencies, and package metadata for the Gradebook V2 release, inline-first Apple Reminder-style Todo aggregate UX, current settings UI cleanup, split habit-streak dual-widget runtime, multi-instance support, and homepage loading-shell behavior. |
