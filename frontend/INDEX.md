...
| package.json | Package manifest | Frontend scripts, dependencies, and package metadata for the current settings UI cleanup, fact-only Gradebook projection flow, split habit-streak dual-widget runtime, multi-instance support, and homepage loading-shell behavior. |
